...
input[type="date"]::-webkit-calendar-picker-indicator{filter:invert(1);cursor:pointer;opacity:0.9;width:22px;height:22px;padding:4px;margin-left:8px}
input[type="date"]::-webkit-calendar-picker-indicator:hover{opacity:1}
body.light input[type="date"]::-webkit-calendar-picker-indicator{filter:invert(0);opacity:0.7}
