    ...
    <head>
        ...
        <style>
            *{box-sizing:border-box;margin:0;padding:0}
            ...
            .bfh-input{background:#1e1e1e;border:1px solid #3a3a3a;border-radius:10px;padding:13px 14px;width:100%;color:#fff;font-size:14px;outline:none;transition:border-color 0.2s;font-family:'Figtree',sans-serif}
